// Package gate provides implementations of basic logical gates in three different flavours which accept gate pin.Signal
// and [16]pin.Signal parameters respectively. All gates are built on top of the NotAnd gate.
package gate
...
func NotAnd16(a, b [16]pin.Signal) [16]pin.Signal {
...
func Not16(a [16]pin.Signal) [16]pin.Signal {
	return [16]pin.Signal{
		Not(a[0]),
		Not(a[1]),
		Not(a[2]),
...
func And16(a, b [16]pin.Signal) [16]pin.Signal {
	return [16]pin.Signal{
		And(a[0], b[0]),
		And(a[1], b[1]),
		And(a[2], b[2]),
...
func Or16(a, b [16]pin.Signal) [16]pin.Signal {
	return [16]pin.Signal{
		Or(a[0], b[0]),
		Or(a[1], b[1]),
		Or(a[2], b[2]),
...
func Xor16(a, b [16]pin.Signal) [16]pin.Signal {
	return [16]pin.Signal{
		Xor(a[0], b[0]),
		Xor(a[1], b[1]),
		Xor(a[2], b[2]),
...
func Mux2Way16(s pin.Signal, a, b [16]pin.Signal) [16]pin.Signal {
...
func Mux4Way16(s [2]pin.Signal, a, b, c, d [16]pin.Signal) [16]pin.Signal {
...
func Mux8Way16(s [3]pin.Signal, a, b, c, d, e, f, g, h [16]pin.Signal) [16]pin.Signal {
